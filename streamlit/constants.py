...
class RecommendedPrompts:
    ...
    BEST_VERSIONS = {
        ...
        "Main Moderation Prompt-Condensed": "1",
        "Meaningful Misconceptions": "1",
        "Moderation - Discrimination and Offensive Language": "3",
        "Moderation - Nudity and Sexual Content": "3",
        "Moderation - Potentially Harmful Activities": "3",
        "Moderation - Toxicity and Self Harm": "2",
        "Moderation - Upsetting, Sensitive or Distressing Content": "3",
        "Moderation - Violence and Conflict": "2",
