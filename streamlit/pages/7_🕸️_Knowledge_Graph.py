...
query = '''
    SELECT id, source,jsonb_array_length(nodes::jsonb) AS num_nodes,  
       jsonb_array_length(edges::jsonb) AS num_edges
...
if selected_id is not None:
    ...
    kg_data = execute_single_query(query_kg, (selected_id,),True)
    st.write(kg_data)
