...
# Initialise a list to store the final prompt information for the table
selected_prompts_info = []
# Initialise an empty list to store selected prompt IDs
prompt_ids = []
...
for selected_prompt_title in selected_prompt_titles:
    # Filter by Selected Prompt Title
